...
(function (factory) {
	...
	var Politespace = function( element ) {
		...
		this.prefix = this.$element.attr( "data-politespace-prefix" ) || "";
	...
	Politespace.prototype.format = function( value ) {
		...
		return this.prefix + this._divideIntoArray( val ).join( this.delimiter ) + suffix;
	};
	...
	Politespace.prototype.unformat = function( value ) {
		var escapeDelimiter = this.delimiter;
		if(escapeDelimiter == ".")
			escapeDelimiter = "\\."
		return value.replace( new RegExp(  escapeDelimiter, 'g' ), '' );
	};
